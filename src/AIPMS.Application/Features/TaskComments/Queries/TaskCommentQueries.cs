...
public sealed class GetTaskCommentsHandler(ITaskCommentRepository repository, ICurrentUser currentUser, IProjectAccessService projectAccess) : IRequestHandler<GetTaskCommentsQuery, PagedResult<TaskCommentDto>>
{
