...
public interface ISupervisorRequestRepository
{
    ...
    Task<SupervisorRequest?> GetByIdForUpdateAsync(long id, CancellationToken cancellationToken);
    ...
    Task InitializeProjectWorkspaceAsync(long projectId, long actorUserId, CancellationToken cancellationToken);
